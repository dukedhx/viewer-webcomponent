...
export default class {
  ...
  initViewer () {
    return new (this.useGUI ? (Autodesk.Viewing.GuiViewer3D|| Autodesk.Viewing.Private.GuiViewer3D): (Autodesk.Viewing.Viewer3D||Autodesk.Viewing.Private.Viewer3D))(this.container, Object.assign({}, WebComponent.ViewerOptions[this.name], WebComponent.Defaults.ViewerOptions))
  }
}
