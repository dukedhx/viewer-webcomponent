...
export default function () {
  window.customElements.define('forge-viewer', class ForgeViewer extends HTMLElement {
    constructor () {
      super()
      const modelOptions = Object.assign({}, defaultModelLoadOptions, parseObjectFromContent((this.querySelector('model-options') || this.querySelector('options') || {}).textContent))
      ...
      const useShadowRoot = (!useGUI && this.getAttribute('shadow-mode') !== 'false') || shadowmode
      ...
      styles && createStyleElement(styles, useShadowRoot ? root : null)
